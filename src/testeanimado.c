...
// extern char water_frame0;
// extern char water_frame1;
// extern char water_frame2;
// extern char water_frame3;


// #define WATER_VRAM_ADDR 0x0000

// static u8 water_timer = 0;
// static u8 water_frame = 0;

// static u8 water_tilemap[512]; 
// static u8 water_interleaved[4][512];
...
// static inline void dmaCopyVramRom(u16 vram_addr, void* src, u16 size)
// {
//     u32 addr = (u32)src;
...
//     REG_A1T0L = addr & 0xFF;
//     REG_A1T0H = (addr >> 8) & 0xFF;
//     REG_A1B0  = (addr >> 16) & 0xFF;
...
// static void initWaterFrames(void)
// {
//     u16 i;
...
//         for(i = 0; i < 256; i++)
//         {
//             // tile index: pixels 0-63 = tile 0, 64-127 = tile 1, etc.
//             u8 tile_index = (u8)(i >> 6);  // 0,0,0...1,1,1...2,2,2...3,3,3

//             water_interleaved[f][i*2]   = tile_index;   // byte de tilemap
//             water_interleaved[f][i*2+1] = src[f][i];    // byte de pixel
//         }
//     }
// }
...
//     switch(water_frame)
//     {
//         case 0:  src = (u8*)&water_frame0; break;
//         case 1:  src = (u8*)&water_frame1; break;
//         case 2:  src = (u8*)&water_frame2; break;
//         default: src = (u8*)&water_frame3; break;
//     }

//     u16 i;

//     // VMAIN=0x80: endereço incrementa após escrita em $2119
//     // Escreve SÓ em $2119 — $2118 nunca é tocado, tilemap preservado
//     *(volatile u8*)0x2115 = 0x80;
//     *(volatile u8*)0x2116 = 0x00;
//     *(volatile u8*)0x2117 = 0x00;

//     for(i = 0; i < 256; i++)
//     {
//         *(volatile u8*)0x2119 = src[i];
//     }
...
// // buffer global intercalado [pixel, 0x00, pixel, 0x00, ...]
